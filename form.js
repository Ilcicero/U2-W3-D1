...
// campo nome
const NamePetInput = document.getElementById('name-field')
// campo cognome
const OwnerPetInput = document.getElementById('owner-field')
// campo telefono
const SpeciesInpunt = document.getElementById('species-field')
const BreedInpunt = document.getElementById('breed-field')
